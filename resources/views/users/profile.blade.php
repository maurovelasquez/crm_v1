@extends('layouts.main', ['activePage' => 'profiles', 'titlePage' => 'profile'])
@section('content')
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <meta name="csrf-token" content="lX1DOe410TBxTozgzOgsCmyna2xuUQSH9nfK3yJO">
    ...
    <title>Material Dashboard Laravel - Free Frontend Preset for Laravel</title>
    <link rel="apple-touch-icon" sizes="76x76" href="https://material-dashboard-laravel.creative-tim.com/material/img/apple-icon.png">
    <link rel="icon" type="image/png" href="https://material-dashboard-laravel.creative-tim.com/material/img/favicon.png">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NKDMSK6"
      ...
      <!-- End Google Tag Manager (noscript) -->
                ...
                <input type="hidden" name="_token" value="lX1DOe410TBxTozgzOgsCmyna2xuUQSH9nfK3yJO">            </form>
            <div class="wrapper ">
  ...
  <div class="sidebar-wrapper">
    <ul class="nav">
      ...
      <li class="nav-item active-pro">
        <a class="nav-link text-white bg-danger" href="https://material-dashboard-laravel.creative-tim.com/upgrade">
...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
  <div class="container-fluid">
    ...
    <a class="btn btn-danger mr-4" target="_blank" href="https://www.creative-tim.com/product/material-dashboard-laravel?_ga=2.155843325.799530425.1606120735-1793253030.1606120735">
      <i class="material-icons">archive</i>
        <span>Download Now</span>
    <div class="ripple-container"></div></a>
    <a class="btn btn-success" target="_blank" href="https://material-dashboard-laravel.creative-tim.com/docs/getting-started/laravel-setup.html?_ga=2.155843325.799530425.1606120735-1793253030.1606120735">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
            <a class="dropdown-item" href="https://material-dashboard-laravel.creative-tim.com/profile">Profile</a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="https://material-dashboard-laravel.creative-tim.com/logout" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Log out</a>
          </div>
        </li>
      </ul>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="https://material-dashboard-laravel.creative-tim.com/profile" autocomplete="off" class="form-horizontal">
            <input type="hidden" name="_token" value="lX1DOe410TBxTozgzOgsCmyna2xuUQSH9nfK3yJO">            <input type="hidden" name="_method" value="put">
            <div class="card ">
          ...
          <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="button-container github-star">
                <a class="github-button" href="https://github.com/creativetimofficial/material-dashboard-laravel" data-icon="octicon-star" data-size="large" data-show-count="true" target="_blank" aria-label="Star ntkme/github-buttons on GitHub">Star</a>
              </li>
